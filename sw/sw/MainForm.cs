...
//					}
		...
		void Panel1Paint(object sender, PaintEventArgs e)
		{
		    ...
		    {		       
				...
				lStatus.BackColor=Color.FromArgb((int)rs["r"],(int)rs["g"],(int)rs["b"]);
				if (lStatus.BackColor.R==0 && lStatus.BackColor.G==0 && lStatus.BackColor.B==0)				
					lStatus.BackColor=lStatus.Parent.BackColor;					
